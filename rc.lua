...
globalkeys = awful.util.table.join(
    ...
    -- Screen Lock
    awful.key({ altkey }, "F12", function() os.execute("lock") end),
    ...
    awful.key({ altkey }, "Up",
        function ()
            awful.util.spawn(string.format("amixer -q sset Master 3%%+", volumewidget.card, 
volumewidget.channel))
            volumewidget.update()
        end),
    awful.key({ altkey }, "Down",
        function ()
            awful.util.spawn(string.format("amixer -q sset Master 3%%-", volumewidget.card, volumewidget.channel))
            volumewidget.update()
        end),
    awful.key({ altkey }, "m",
        function ()
            awful.util.spawn(string.format("amixer -q sset Master toggle", volumewidget.card, volumewidget.channel))
